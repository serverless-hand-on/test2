...
namespace TollBooth
{
    public class FindLicensePlateText
    {
        ...
        private async Task<string> MakeOCRRequest(byte[] imageBytes)
        {
            ...
            var uriBase = Environment.GetEnvironmentVariable("https://westeurope.api.cognitive.microsoft.com/");
            var apiKey = Environment.GetEnvironmentVariable("e8acd8783c334b2e99f6d0211af4ed68");
